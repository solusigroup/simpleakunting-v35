...
class Penerimaan_model {
     ...
     * @param int $id ID penerimaan yang akan dihapus
     * @return bool
     */
    public function hapusPenerimaan($id) {
        ...
        try {
            // 1. Ambil data header penerimaan
            $this->db->query("SELECT * FROM penerimaan_pelanggan WHERE id_penerimaan = :id");
            $this->db->bind('id', $id);
            ...
            // 2. Ambil detail penerimaan dan kembalikan sisa tagihan faktur
            ...
            foreach ($details as $detail) {
                ...
                // Kembalikan sisa tagihan ke faktur penjualan
            ...
            $this->db->query("DELETE FROM penerimaan_pelanggan WHERE id_penerimaan = :id");
            $this->db->bind('id', $id);
            $this->db->execute();
