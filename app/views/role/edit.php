<div class="row justify-content-center">
    <div class="col-lg-10">
        <div class="d-flex align-items-center mb-4">
            ...
            <h3 class="fw-bold mb-0">Edit Hak Akses: <?php echo htmlspecialchars($data['role']['role_name']); ?></h3>
        </div>

        <form action="<?php echo BASEURL; ?>/role/update" method="post">
                ...
                <div class="card-body p-4">
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control bg-light border-0" id="role_name" name="role_name" value="<?php echo htmlspecialchars($data['role']['role_name']); ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label for="description" class="form-label fw-bold small text-muted text-uppercase">Deskripsi</label>
                            <input type="text" class="form-control bg-light border-0" id="description" name="description" value="<?php echo htmlspecialchars($data['role']['description']); ?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body p-4">
                    ...
                    $current_perms = $data['role']['permissions'];
                    ?>
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check form-switch custom-switch">
                                            <input class="form-check-input" type="checkbox" name="permissions[]" value="<?php echo $p['id']; ?>" id="perm_<?php echo $p['id']; ?>" <?php echo in_array($p['permission_key'], $current_perms) ? 'checked' : ''; ?>>
